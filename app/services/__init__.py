...
from app.services.similarity_service import rebuild_user_graph, relationship_label, explain_connection
...
__all__ = [
    ...
    'rebuild_user_graph', 'relationship_label', 'explain_connection',
